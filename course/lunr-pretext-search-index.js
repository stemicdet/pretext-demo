...
},
{
  ...
  "number": "4",
  "title": "",
  "body": " The idea of the proof is that we can approximate step functions by continuous functions by connecting the pieces with lines.  For every , , and it follows from the properties of the norm that   Since we can approximate functions by step functions, we can find numbers and to make as small as we want.  As in the picture, we can construct continuous functions so that is as small as we want. Thus letting gives us a continuous function that can be made arbitrarily close to as desired.  "
},
{
  "id": "homework-2",
  "level": "1",
